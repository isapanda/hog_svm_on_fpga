...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_DISPLAY_START_ADDRESS" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_DISPLAY_START_ADDRESS { PARAM_VALUE.C_DISPLAY_START_ADDRESS } {
	# Procedure called to update C_DISPLAY_START_ADDRESS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_DISPLAY_START_ADDRESS { PARAM_VALUE.C_DISPLAY_START_ADDRESS } {
	# Procedure called to validate C_DISPLAY_START_ADDRESS
	return true
}
...
proc update_MODELPARAM_VALUE.C_DISPLAY_START_ADDRESS { MODELPARAM_VALUE.C_DISPLAY_START_ADDRESS PARAM_VALUE.C_DISPLAY_START_ADDRESS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_DISPLAY_START_ADDRESS}] ${MODELPARAM_VALUE.C_DISPLAY_START_ADDRESS}
}
